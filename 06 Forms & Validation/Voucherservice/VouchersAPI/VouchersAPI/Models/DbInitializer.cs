...
namespace Vouchers
{
    public static class DbInitializer
    {
        public static void Initialize(VouchersDBContext context)
        {
            ...
            {
                var a1 = new BalanceAccount { Name = "Depreciation", Expense = true, Balance = 0.3, Created = DateTime.Now };
                var a2 = new BalanceAccount { Name = "Car Maintenance", Expense = true, Balance = 30.3, Created = DateTime.Now };
                var a3 = new BalanceAccount { Name = "Development", Expense = false, Balance = 653, Created = DateTime.Now };
                var a4 = new BalanceAccount { Name = "Consulting", Expense = false, Balance = 66.3, Created = DateTime.Now };
                var a5 = new BalanceAccount { Name = "Training", Expense = false, Balance = 989.3, Created = DateTime.Now };
                var a6 = new BalanceAccount { Name = "Software", Expense = true, Balance = 457563, Created = DateTime.Now };
                var a7 = new BalanceAccount { Name = "Hosting & Internet", Expense = true, Balance = 7.8, Created = DateTime.Now };
